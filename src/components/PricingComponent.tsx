...
export default function PricingComponent() {
  ...
  return (
    <div className="h-fit flex items-center justify-center w-5/6 mx-auto py-[60px]">
      <div className="flex flex-col gap-[50px] h-full w-full">
        <motion.div
        ...
        >
          <div className="flex items-center border-[1px] px-[11px] py-[2px] gap-[7px] rounded-full border-primary-violet-500 cursor-pointer ">
            ...
            <p className="text-primary-violet-500 text-[16px]">PRICING</p>
          </div>
        ...
        <div className="flex-1 flex flex-col items-center w-full gap-[35px] h-full">
          <div className="flex gap-[30px] w-full justify-center items-center">
            ...
            />
            <p className="text-neutral-200 font-semibold text-[24px]  ">
              Berlangganan Tahunan Hemat 20%
            </p>
          </div>
          <div className="flex gap-[35px] h-full w-full justify-center">
            {/* free */}
            <motion.div
              initial={{
                opacity: 1,
              ...
              className={`${
                selected ? "hidden" : ""
              } bg-neutral-100 w-1/3 rounded-xl p-[8px]`}
            >
              <div className="bg-neutral-100 border-[1px] border-neutral-400 w-full h-full rounded-xl p-[25px]">
                <p className="font-nunito font-bold text-[24px] text-black ">
                  Gratis!
                </p>
                <p className="font-nunito font-semibold text-[45px] text-black ">
                  Rp. 0{" "}
                ...
                <div className="mt-[24px] w-full bg-neutral-400 flex items-center justify-center py-[10px] rounded-xl cursor-pointer hover:bg-gradient-to-br from-[#7f52ff] to-[#FB8570] text-white">
                  <p className="text-[20px]">Coba Gratis</p>
                </div>
                <div className="w-full my-[40px] flex items-center gap-[15px]">
            ...
            {/* PRO */}
            <div className="bg-primary-violet-500 w-1/3 rounded-xl p-[8px]">
              <div className="bg-primary-violet-500 border-[1px] w-full h-full rounded-xl p-[25px]">
                <p className="font-nunito font-bold text-[24px] text-white ">
                  Pro
                </p>
                <p className="font-nunito font-semibold text-[45px] text-white ">
                ...
                <div className="mt-[24px] w-full bg-white flex items-center justify-center py-[10px] rounded-xl cursor-pointer hover:bg-gradient-to-br from-[#7f52ff] to-[#FB8570] hover:text-white ">
                  <p className="text-[20px] ">Mulai Bikin Video</p>
                </div>
                <div className="w-full my-[40px] flex items-center gap-[15px]">
            ...
            {/* custom */}
            <div className="bg-[#2C323E] w-1/3 rounded-xl p-[8px]">
              <div className="bg-[#393F4A] border-[1px] w-full h-full rounded-xl p-[25px]">
                <p className="font-nunito font-bold text-[24px] text-white ">
                  Enterprise
                </p>
                <p className="font-nunito font-semibold text-[45px] text-white ">
                ...
                <div className="mt-[24px] w-full bg-white flex items-center justify-center py-[10px] rounded-xl cursor-pointer hover:bg-gradient-to-br from-[#7f52ff] to-[#FB8570] hover:text-white">
                  <p className="text-[20px] ">Hubungi Kami</p>
                </div>
                <div className="w-full my-[40px] flex items-center gap-[15px]">
                  ...
                  <div className="border-1 w-fit px-[10px] rounded-full border-white flex-shrink-0  ">
                    <p className="text-[14px] text-white">WHAT YOU WILL GET</p>
                  </div>
